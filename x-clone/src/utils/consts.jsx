    ...
    },
    {
        ...
        icon: {
            active: (
                <svg viewBox="0 0 24 24" width={26.25} height={26.25}>
                    <g >
                        <path fill="currentColor" fill-rule="evenodd" d="M6 2h12c2.21 0 4 1.79 4 4v12c0 2.21-1.79 4-4 4H6c-2.21 0-4-1.79-4-4V6c0-2.21 1.79-4 4-4zm.643 15.8l8.109-11.58h2.515L9.158 17.8H6.643z" />
                    </g>
                </svg >
            ),
            passive: (
                <svg viewBox="0 0 24 24" width={26.25} height={26.25}>
                    <g >
                        <path fill="currentColor" d="M18 4.1H6c-1.05 0-1.9.85-1.9 1.9v12c0 1.05.85 1.9 1.9 1.9h12c1.05 0 1.9-.85 1.9-1.9V6c0-1.05-.85-1.9-1.9-1.9zM6 2h12c2.21 0 4 1.79 4 4v12c0 2.21-1.79 4-4 4H6c-2.21 0-4-1.79-4-4V6c0-2.21 1.79-4 4-4z" />
                        <path fill="currentColor" d="M6.68 17.8l8.108-11.58h2.532L9.21 17.8H6.68z" />
                    </g>
                </svg >
            )
        }
