...
export const mainMenu = [
    ...
    },
    {
        ...
        icon: {
            active: (
                <svg viewBox="0 0 24 24" width={26.25} height={26.25}>
                    <g >
                        <path fill="#e7e9ea" fill-rule="evenodd" d="M6 2h12c2.21 0 4 1.79 4 4v12c0 2.21-1.79 4-4 4H6c-2.21 0-4-1.79-4-4V6c0-2.21 1.79-4 4-4zm.643 15.8l8.109-11.58h2.515L9.158 17.8H6.643z" />
                    </g>
                </svg >
            ),
            passive: (
                <svg viewBox="0 0 24 24" width={26.25} height={26.25}>
                    <g >
                        <path fill="#e7e9ea" d="M18 4.1H6c-1.05 0-1.9.85-1.9 1.9v12c0 1.05.85 1.9 1.9 1.9h12c1.05 0 1.9-.85 1.9-1.9V6c0-1.05-.85-1.9-1.9-1.9zM6 2h12c2.21 0 4 1.79 4 4v12c0 2.21-1.79 4-4 4H6c-2.21 0-4-1.79-4-4V6c0-2.21 1.79-4 4-4z" />
                        <path fill="#e7e9ea" d="M6.68 17.8l8.108-11.58h2.532L9.21 17.8H6.68z" />
                    </g>
                </svg >
            )
        }
    ...
    },
    {
        ...
        icon: {
            active: (
                <svg viewBox="0 0 24 24" width={26.25} height={26.25}>
                    <path fill="#e7e9ea" d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                </svg>
            ),
            passive: (
                <svg viewBox="0 0 24 24" width={26.25} height={26.25}>
    ...
    },
    {
        ...
        icon: {
            active: (
                <svg viewBox="0 0 24 24" width={26.25} height={26.25}>
                    <path fill="#e7e9ea" d="M17.863 13.44c1.477 1.58 2.366 3.8 2.632 6.46l.11 1.1H3.395l.11-1.1c.266-2.66 1.155-4.88 2.632-6.46C7.627 11.85 9.648 11 12 11s4.373.85 5.863 2.44zM12 2C9.791 2 8 3.79 8 6s1.791 4 4 4 4-1.79 4-4-1.791-4-4-4z" />
                </svg>
            ),
            passive: (
                <svg viewBox="0 0 24 24" width={26.25} height={26.25}>
