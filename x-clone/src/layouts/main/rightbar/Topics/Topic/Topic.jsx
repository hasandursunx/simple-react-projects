    ...
    return (
        ...
        >
            ...
            <Popover className="absolute top-1.5 right-2">
                <PopoverButton
                    className='outline-none w-[34.75px] h-[34.75px] rounded-full text-[#71767b]  flex items-center justify-center hover:bg-[#1d9bf01a] transition-colors '
                >
                ...
                <PopoverPanel className="z-[1] grid w-[384px] rounded-xl absolute top-2 right-2 overflow-hidden  bg-[color:var(--background-primary)]  shadow-box text-[15px] leading-5 font-bold text-[#e7e9ea]">
