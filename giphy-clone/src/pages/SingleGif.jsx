...
const contentType = ["gif", "stickers", "text"];
...
const SingleGif = () => {
    ...
    return (
        <div className="grid grid-col-4 my-10 gap-4">
                ...
                {gif?.user && (
                    <>
                        ...
                        <div className="px-2">
                            ...
                            <div className="faded-text">@{gif?.user?.usernama}</div>
                        </div>
                        {gif?.user?.description && (
                            <p className="py-4 whitespace-pre-line text-sm text-gray-500">
                                {readMore
                                    ? gif?.user?.description
