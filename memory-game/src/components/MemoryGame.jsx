...
function MemoryGame() {
    ...
    return (
        <div className='flex flex-col items-center justify-center min-h-screen bg-gray-100 p-4'>
            ...
            <div className='mb-4'>
                <label className='mr-2' htmlFor=" "> GridSize : (max 10)</label>
                <input
                    type="number"
                    id='gridSize'
                    min={2}
            ...
            >{cards.map((card) => {
                return <div
                    ...
                    key={card.id}
                    className={`
                    aspect-square flex items-center justify-center text-xl
                    font-bold rounded-lg cursor-pointer transition-all duration-300
                    ${isFlipped(card.id)
                            ? isSolved(card.id)
